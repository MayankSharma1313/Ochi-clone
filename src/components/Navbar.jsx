  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
          key="navbar"
          className="fixed top-0 z-[999] w-full px-20 py-8 flex justify-between backdrop-blur-sm items-center max-sm:pl-0"
          initial={{ y: -50 }}
          animate={{ y: 0 }}
          exit={{ y: -50 }}
          transition={{ duration: 0.3 }}
        >
          <div className="logo max-sm:pl-8">
            <svg
              width="72"
              height="30"
              viewBox="0 0 72 30"
          ...
          <div className="links flex gap-10 max-sm:hidden">
